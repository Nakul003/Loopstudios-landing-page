    ...
    <div>
      <nav className='lg:hidden'>
        <div className='flex justify-between w-full py-[2.5rem] px-[1.5rem] items-center'>
          ...
          <ul style={{left:Left}} className={`fixed pt-[13rem] ${Display} transition-all duration-300 pl-[1.5rem] font-Josefin font-light text-2xl items-start gap-4 z-10 top-0  w-screen h-screen bg-black text-white flex flex-col justify-center pb-[10rem] sm:items-center`}>
          <li>ABOUT</li>
          <li>CAREERS</li>
          <li>EVENTS</li>
          <li>PRODUCTS</li>
